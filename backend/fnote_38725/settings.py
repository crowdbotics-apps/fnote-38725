"""
Django settings for fnote_38725 project.
...
WSGI_APPLICATION = 'fnote_38725.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fnote_38725 API",
    "DESCRIPTION": "API documentation for fnote_38725 App",
    "VERSION": "v1",
}
